<template>
  <CModal :visible="visible" backdrop="static" size="xl" @close="close()">
    <CModalHeader closeButton><h5 class="fw-bold"> {{ isNew ? "New" : "Update" }} Item Check Request</h5></CModalHeader>
    <CModalBody>
      <Toaster position="top-center" closeButton/>
      <NewUpdate ref="NewUpdated" :is-new="isNew"/>
    </CModalBody>
  </CModal>
</template>
<script>
